...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" role="navigation" aria-label="Navigasi utama">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navInventories" role="menu">
                                ...
                                <form method="POST" action="{{ route('inventories.destroy', 1) }}" class="px-3" onsubmit="return confirm('Padam contoh inventori? Ini akan memadam rekod contoh jika wujud.');">
                                    @csrf
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navVehicles" role="menu">
                                ...
                                <div class="dropdown-divider"></div>
                                <form method="POST" action="{{ route('vehicles.destroy', 1) }}" class="px-3" onsubmit="return confirm('Padam contoh kenderaan? Ini akan memadam rekod contoh jika wujud.');">
                                    @csrf
